...
import com.capgemini.airlinereservationsystem.exceptions.UserLoginException;
import com.capgemini.airlinereservationsystem.exceptions.UserRegisterException;
...
public class UserDAOImpl implements UserDAO {
	...
	@Override
	public UserBean userLogin(String userId, String userPassword) throws UserLoginException {
		String role = null;
		...
		if (userBean != null) {
			...
			if (password.equals(userPassword)) {
				Query query = entityManager
						.createQuery("From UserBean where userId =:userId and userPassword =: password");
