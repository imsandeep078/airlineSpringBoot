...
public class BookingDeleteBookingSteps {
	...
	@Then("^Delete your booking detail$")
	public void deleteFlight() throws Throwable{
		System.out.println("Delete your booking details");
	}
}
